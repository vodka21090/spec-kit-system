...
Audit, evaluate, and improve AGENTS.md files across a codebase to ensure Agent Code has optimal project context.
...
**Note:** Agent auto-discovers AGENTS
.md files in parent directories, making monorepo setups work automatically.
...
- **`#` key shortcut**: During a Claude session, press `#` to have Claude auto-incorporate learnings into AGENTS.md
...
- **Global defaults**: Put user-wide preferences in `~/.agents/AGENTS.md`
